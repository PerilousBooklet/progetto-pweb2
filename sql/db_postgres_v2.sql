CREATE TABLE autostrada (
    ...
    CONSTRAINT cod_naz_autostrada_pk PRIMARY KEY (cod_naz)
);
...
CREATE TABLE casello (
    ...
    CONSTRAINT codice_casello_pk PRIMARY KEY (codice)
);
...
CREATE TABLE comune (
    ...
    nome varchar NOT NULL,
    CONSTRAINT codice_comune_pk PRIMARY KEY (codice)
);
...
CREATE TABLE provincia (
    ...
    nome varchar NOT NULL,
    CONSTRAINT sigla_provincia_pk PRIMARY KEY (sigla)
);

CREATE TABLE regione (
    codice int NOT NULL,
    nome varchar NOT NULL,
    CONSTRAINT codice_regione_pk PRIMARY KEY (codice)
);

ALTER TABLE casello
    ADD CONSTRAINT cod_naz_casello_fk FOREIGN KEY (cod_naz) REFERENCES autostrada(cod_naz) ON DELETE CASCADE ON UPDATE CASCADE,
    ADD CONSTRAINT comune_casello_fk FOREIGN KEY (comune) REFERENCES comune(codice) ON DELETE CASCADE ON UPDATE CASCADE;


ALTER TABLE comune
    ADD CONSTRAINT comune_provincia_fk FOREIGN KEY (provincia) REFERENCES provincia(sigla) ON UPDATE CASCADE;


ALTER TABLE provincia
    ADD CONSTRAINT regione_provincia_fk FOREIGN KEY (regione) REFERENCES regione(codice) ON UPDATE CASCADE;
